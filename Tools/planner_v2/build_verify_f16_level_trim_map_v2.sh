...
OUT=/tmp/mumt_f16_level_trim_map_v2
BINARY="$OUT/verify_f16_level_trim_map_v2"
...
"$TC/bin/clang++" \
  ...
  "$SCRIPT_DIR/verify_f16_level_trim_map_v2.cpp" \
...
printf 'F16_LEVEL_TRIM_MAP_V2_RESULT=PASS\n'
