...
OUT=/tmp/mumt_f16_trim_sensitivity_matrix_v2
BINARY="$OUT/verify_f16_trim_sensitivity_matrix_v2"
...
"$TC/bin/clang++" \
  ...
  "$SCRIPT_DIR/verify_f16_trim_sensitivity_matrix_v2.cpp" \
...
printf 'F16_TRIM_SENSITIVITY_MATRIX_V2_RESULT=PASS\n'
