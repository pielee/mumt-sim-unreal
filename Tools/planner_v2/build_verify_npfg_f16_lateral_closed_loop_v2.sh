...
OUT=/tmp/mumt_npfg_f16_lateral_closed_loop_v2
BINARY="$OUT/verify_npfg_f16_lateral_closed_loop_v2"
...
"$TC/bin/clang++" \
  ...
  "$SCRIPT_DIR/verify_npfg_f16_lateral_closed_loop_v2.cpp" \
...
printf 'NPFG_F16_LATERAL_CLOSED_LOOP_V2_RESULT=PASS\n'
