...
OUT=/tmp/mumt_tecs_f16_longitudinal_closed_loop_v2
BINARY="$OUT/verify_tecs_f16_longitudinal_closed_loop_v2"
...
# library: the coordinator (which owns the real PX4 TECS and NPFG adapters) and the F-16 stick
...
# vendored PX4 v1.17.0 TECS/NPFG sources carry unused parameters in their upstream signatures, and
...
"$TC/bin/clang++" \
  ...
  "$SCRIPT_DIR/verify_tecs_f16_longitudinal_closed_loop_v2.cpp" \
...
printf 'TECS_F16_LONGITUDINAL_CLOSED_LOOP_V2_RESULT=PASS\n'
